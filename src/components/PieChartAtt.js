...
const PieChartAtt = () => {
    ...
    return ( <
        ...
        className = "logo"
        onClick = {
            () => setLeagueEraseTeam("Premier League") } >
        < /img> <
        img src = { BL }
        className = "logo"
        onClick = {
            () => setLeagueEraseTeam("Bundesliga") } >
        < /img> <
        img src = { LL }
        className = "logo"
        onClick = {
            () => setLeagueEraseTeam("La Liga") } >
        < /img> <
        img src = { LONE }
        className = "logo"
        onClick = {
            () => setLeagueEraseTeam("Ligue 1") } >
        < /img> <
        img src = { SA }
        className = "logo"
        onClick = {
            () => setLeagueEraseTeam("Serie A") } >
        < /img> <
        /div>
...

        {
            team != "" ? ( <
                ...
                <
                h2 style = {
                    { textAlign: "left", marginLeft: "200px" } } > { team }
                ...
                /> {
                    season != "" ? ( <
                        ...
                        <
                        FunnelChart width = { 850 }
                        height = { 580 } >
                        <
                        Funnel dataKey = "points"
